<template>
  <v-app>
    <div class="box17">
      <h3>新規のご契約</h3>
      <p>
        この度は読売新聞をお選びいただき、誠にありがとうございます。
        訪問契約の他にスマートフォンでのオンライン契約更新、各種お申し込みも行わせて頂きますので
        よろしければご利用ください。
      </p>
    </div>
    <h3 class="title1">新規ご契約フォーム</h3>
          ...
          <div>
            ...
            <v-container>
              <v-row dense>
                ...
                <v-col md="4">
                  <v-card class="mx-auto justify-space-around" max-width="300">
                    <template slot="progress">
                      <v-progress-linear
                        color="deep-purple"
                        height="10"
...
export default {
  ...
  methods: {
    add() {
      this.$store.dispatch("newcontructs/add", {
        name: this.name,
